document.addEventListener('DOMContentLoaded', function() {
    const evacDiv = document.getElementById('factoryFacts');
    const deportDiv = document.getElementById('crossFacts');
    const showEvacBtn = document.getElementById('showFactsBtn');
    const showDeportBtn = document.getElementById('showCrossBtn');
