ymaps.ready(init);
    function init() {
        ...
        arrivals.forEach(a => {
            const placemark = createPlacemark(a.coords, a.title, a.file, '#d47b28');
        ...
        // Пункты отправления (жёлтые)
        const departures = [
            {coords:[59.939,30.315], title:'Ленинград'},
            {coords:[55.755,37.617], title:'Москва'},
            {coords:[50.450,30.523], title:'Киев'},
            {coords:[53.904,27.561], title:'Минск'},
            {coords:[46.485,30.743], title:'Одесса'},
            {coords:[47.910,33.391], title:'Кривой Рог'},
            {coords:[49.993,36.230], title:'Харьков'},
            {coords:[47.838,35.140], title:'Запорожье'},
            {coords:[48.022,37.802], title:'Донбасс (Донецк)'},
            {coords:[56.946,24.105], title:'Рига'},
            {coords:[59.437,24.753], title:'Таллин'},
            {coords:[54.687,25.280], title:'Вильнюс'}
        ];

        departures.forEach(d => {
            const placemark = new ymaps.Placemark(d.coords, {
                balloonContent: `<b>${d.title}</b>`
            }, {
                preset: 'islands#circleIcon',
                iconColor: '#e8b34b',
                balloonMaxWidth: 300
