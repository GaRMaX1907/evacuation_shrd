document.addEventListener('DOMContentLoaded', function() {
    const evacDiv = document.getElementById('evacFacts');
    const deportDiv = document.getElementById('deportFacts');
    const showEvacBtn = document.getElementById('showFactsBtn');
    const showDeportBtn = document.getElementById('showDeportBtn');
